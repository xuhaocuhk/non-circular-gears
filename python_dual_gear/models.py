...
our_models = [Model(name='circular', sample_num=512, center_point=(0, 0), tooth_height=0.04, tooth_num=32),
              Model(name='ellipse', sample_num=1024, center_point=(0, 0), tooth_height=0.02, tooth_num=32),
